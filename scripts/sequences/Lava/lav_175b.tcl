...
do_wait camera
sq_object summon Drachen_Ei [Getobjpos  [obj_query 0 -class Info_Pos_Zwerg]]
...
do_action transport EiPutPos 0
link_obj [Object 0]
sq_pen move EiPutPos {-0.1 0 0}
+set_pos [Object 0] [parse_pos EiPutPos]

#sq_object beam EiPutPos 0
...
do_action anim drache.sitzen_knuddeln_end 1
do_action anim scratchhead 0
...
do_wait time 1.0
sq_camera selset inout
#sq_camera move 3 1.3 -0.3 0.4 0.4
...
change_particlesource [Actor 2] 3 34 {-0.5 0.4 1.5} {0 -0.1 0.7} 106 4 0 0 0 1
set_particlesource [Actor 2] 3 1
change_particlesource [Actor 2] 4 34 {0.4 0.4 1.5} {0 -0.1 0.7} 106 4 0 0 0 1
set_particlesource [Actor 2] 4 1
change_particlesource [Actor 2] 5 34 {-1 0 -1} {0 -0.1 0.2} 106 4 0 0 0 1
set_particlesource [Actor 2] 5 1
change_particlesource [Actor 2] 6 35 {0 -2 -1.0} {0 0 0} 106 4 0 0 0 1
set_particlesource [Actor 2] 6 1

sq_pen set BrennerPos 2
sq_pen move BrennerPos {2 0 0}
sq_pen set HammerCam 2
sq_pen move HammerCam {1 0 -4}
sq_camera move HammerCam 1.2 -0.3 -0.5 0.1
sq_pen set NeuHammerPos 2
...
do_action anim drache.sitzen_zu_pumpe_loop 1
set_rotz [Object 1] 1.57
set_physic [Object 1] 0

sq_pen set HamPos 3
sq_pen move HamPos {0 -0.3 0}

sq_object beam 1 HamPos


#4
change_particlesource [Actor 4] 3 34 {0 0.4 0} {0 -0.1 0.7} 106 4 0 0 0 1
set_particlesource [Actor 4] 3 1
change_particlesource [Actor 4] 4 34 {0.4 0.4 0} {0 -0.1 0.7} 106 4 0 0 0 1
set_particlesource [Actor 4] 4 1
change_particlesource [Actor 4] 5 34 {0 0 0} {0 -0.1 0.2} 106 4 0 0 0 1
set_particlesource [Actor 4] 5 1
change_particlesource [Actor 4] 6 35 {0 0 -0.5} {0 0 0} 106 4 0 0 0 1
set_particlesource [Actor 4] 6 1
...
set_particlesource [Actor 4] 5 0
set_particlesource [Actor 4] 6 0
do_wait time 1
#Test !!


#+free_particlesource [Actor 4] 3 1
#+free_particlesource [Actor 4] 4 1
#+free_particlesource [Actor 4] 5 1
#+free_particlesource [Actor 4] 6 1
do_wait time 2
...
do_wait time 3
+del [obj_query 0 -class Drachen_Ei]
