sq_text file Lava
adaptive_sound changethemenow s370
sq_audio open Fenris_370
...
-sound play fe_setzten 1
-sq_screenvibe steps
do_action anim drinkstopa 1
sq_wait none
do_text 370a 1 { getupfast } 370a
do_wait time 2.5
...
-sq_screenvibe steps
do_wait time 0.3
-sound play fe_schritt2 0.6
-sq_screenvibe steps
do_wait time 0.3
-sound play fe_schritt1 0.55
-sq_screenvibe steps
do_wait time 0.3
sq_wait 2
do_text 370b 2 NoAnim 370b { 40 20 } Off
