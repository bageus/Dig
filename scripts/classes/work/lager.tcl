...
def_class Lager wood production 0 {} {
    ...
    handle_event evt_btn_on {
		global store_food store_mushroomcap store_mushroomtrunk store_stone store_coal store_iron store_gold store_crystal store_weapons store_tools store_potions store_books store_rings store_boxes store_mushrooms store_minerals store_rawminerals store_misc storage_list current_worker current_itemtype
...
//			log "lager.tcl : is_storable_itemtypelist : finished, remaining itemtypelist: $itemtypelist"
		...
		proc get_classes_to_store {} {
			global store_food store_mushroomcap store_mushroomtrunk store_stone store_coal store_iron store_gold store_crystal store_weapons store_tools store_potions store_books store_rings store_boxes store_mushrooms store_rawminerals store_minerals store_misc
