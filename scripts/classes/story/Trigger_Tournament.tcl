		...
		if {$positiv} {
			...
			switch $possibility {
				...
				"onladdertop" {
					...
					send_trigger "Trigger_Tournament_Thief_Fight"
				...
				"noseqexist" {
					...
					tasklist_add this {exec_deferred {call GameScripts/single_CampaignX.tcl}}
					state_disable this
				}
			}
...
def_class Trigger_tourn_2170 none dummy 0 {} {
	...
	method destroy_overload {} {
		...
		switch $context {
			"tutorial" {
				exec_deferred {call data/GameScripts/single_Tutorial.tcl}
			}
			"tournament" {
				exec_deferred {call data/GameScripts/single_Tournament.tcl}
			}
		}
		destroy 1
	}
