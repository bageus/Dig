...
public static class JobErrors
{
    ...
    public static readonly DomainError ToolPreparationUnavailable = new DomainError(
        "jobs.tool_preparation_unavailable",
        "Automatic tool preparation is not configured for this assignment.");
}
}
