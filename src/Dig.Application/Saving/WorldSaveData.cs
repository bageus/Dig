...
public sealed class WorldSaveData
{
    ...
    [DataMember(Order = 3)] public int Depth { get; set; }
    [DataMember(Order = 4)] public int ChunkSize { get; set; }
    [DataMember(Order = 5)] public long Version { get; set; }
    [DataMember(Order = 6)] public List<WorldChunkSaveData> Chunks { get; set; } = new List<WorldChunkSaveData>();
}
...
public sealed class WorldChunkSaveData
{
    ...
    [DataMember(Order = 5)] public List<WorldCellSaveData> Cells { get; set; } = new List<WorldCellSaveData>();
}
...
public sealed class WorldCellSaveData
{
    ...
    [DataMember(Order = 2)] public int Y { get; set; }
    [DataMember(Order = 3)] public int Z { get; set; }
    [DataMember(Order = 4)] public string MaterialId { get; set; } = string.Empty;
    [DataMember(Order = 5)] public int Designation { get; set; }
