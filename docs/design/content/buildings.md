...
Главная задача расширения зданий и сервисов: #74. Универсальные коробки, placement и packing: #118. Металлургические здания и Песчаник: #108.
...
|---|---|---:|---:|---|
| Пост часового | data-driven production | 1 | 1 | тревога, запас оружия 1/2/4 |
| Арсенал | data-driven production | data-driven | storage | 20 оружий + 6 щитов |
...
| Пивоварня | data-driven | production worker | по Production | пиво, эль, сидр |
| Костёр | data-driven | Q-018 | по Production | кухня tier 1 |
...
| Горн | data-driven | data-driven | по Production | плавка железа |
| Литейный цех | data-driven | data-driven | по Production | плавка железа и золота |
...
- 6 shield slots по центру;
- stable slot index и visual anchor;
- `CollectVisibleWeapons` собирает раскрытые world stacks;
