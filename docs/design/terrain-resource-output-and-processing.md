...
Save format v13 и mining-output section v2 сохраняют:
...
Migration `save.v12_to_v13.terrain_output_contract` переводит mining-output ledger v1 в multi-line v2 и заменяет legacy `material.metal` на `material.iron` во всех сохраняемых Inventory, jobs, production, runtime, barrel и mining-output ссылках.
