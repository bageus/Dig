...
- **Статус:** `OPEN`
- **Подтверждено:** индивидуальные вкусовые профили не нужны; работает desired dish и история 10 трапез.
- **Нужно уточнить:** matched meal восстанавливает Mood только до 50? Может ли diversity bonus поднимать Mood выше 50? Fallback по-прежнему не даёт положительный Mood?
- **Связи:** #96, #99, #144.
