...
6. Последующее падение Stonework не меняет существующий plan.
7. Progress считается по фактически выкопанным клеткам.
8. Своды восстанавливаются из provenance.
