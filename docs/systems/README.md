...
| Приготовление и использование пищи в костре | grilled mushroom, гриль-гриб, шляпка гриба, Cooking, pickup arrow, зелёный рот, Alt+LMB, три укуса | `APPROVED` | [`campfire-cooking-and-food-use.md`](../design/campfire-cooking-and-food-use.md) | [#459](https://github.com/bageus/Dig/issues/459) |
...
| Campfire food meals | eating, Nutrition, three bites, interruption, direct food use | `APPROVED` | [`../design/campfire-cooking-and-food-use.md`](../design/campfire-cooking-and-food-use.md), [`../design/needs-continuous-actions.md`](../design/needs-continuous-actions.md) | [`../implementation/campfire-cooking-and-food-use.md`](../implementation/campfire-cooking-and-food-use.md), [#459](https://github.com/bageus/Dig/issues/459) |
...
| Campfire cooking and food use | grilled mushroom, mushroom cap dependency, Cooking, output ring, direct pickup/eat | `APPROVED` | [`../design/campfire-cooking-and-food-use.md`](../design/campfire-cooking-and-food-use.md) | [`../implementation/campfire-cooking-and-food-use.md`](../implementation/campfire-cooking-and-food-use.md), [#459](https://github.com/bageus/Dig/issues/459) |
