...
| Производство в зданиях и внутреннее снабжение | костёр, recipe icon, очередь, internal stock, refill, палатка, мастерская, гриль | `APPROVED` | [`building-production-and-internal-supply.md`](../design/building-production-and-internal-supply.md) | [#433](https://github.com/bageus/Dig/issues/433) |
