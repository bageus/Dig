...
| BuildingBox selection, unpacking, placement, assembly и packing | коробка здания, меню строения, кнопка распаковать, final-building ghost, pack | `APPROVED` | [`building-box-placement-and-packing.md`](../design/building-box-placement-and-packing.md), [`runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) + input/item contracts | [#118](https://github.com/bageus/Dig/issues/118), [#390](https://github.com/bageus/Dig/issues/390), [#398](https://github.com/bageus/Dig/issues/398) |
...
| Производство в зданиях и внутреннее снабжение | костёр, recipe icon, очередь, internal stock, refill, палатка, мастерская, гриль | `IMPLEMENTED` | [`building-production-and-internal-supply.md`](../design/building-production-and-internal-supply.md) | [#433](https://github.com/bageus/Dig/issues/433) |
...
| Presentation host, input, UI и diagnostics | bootstrap, renderer, inspector, read model, notification ticker, debug overlay, 64 residents | `IMPLEMENTED` | [`presentation-input-ui-and-diagnostics.md`](../design/presentation-input-ui-and-diagnostics.md) | [#14](https://github.com/bageus/Dig/issues/14) |
...
| BuildingBox lifecycle | select box, unpack button, final-building 3D ghost, assembly, packing | `APPROVED` | [`../design/building-box-placement-and-packing.md`](../design/building-box-placement-and-packing.md), [`../design/contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md), [`../design/runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [`../implementation/packable-building-lifecycle.md`](../implementation/packable-building-lifecycle.md), [`../implementation/runtime-selection-excavation-item-placement.md`](../implementation/runtime-selection-excavation-item-placement.md), [#398](https://github.com/bageus/Dig/issues/398) |
...
| Building production and internal supply | production icons, workstation recipes, internal stock, refill, BuildingBox output | `APPROVED` | [`../design/building-production-and-internal-supply.md`](../design/building-production-and-internal-supply.md) | [#433](https://github.com/bageus/Dig/issues/433) |
...
| Production | recipes, queues, outputs | `APPROVED` | [`../design/building-production-and-internal-supply.md`](../design/building-production-and-internal-supply.md), [`../architecture/systems-gameplay.md`](../architecture/systems-gameplay.md#1-строительство-и-экономика) | [#9](https://github.com/bageus/Dig/issues/9), [#433](https://github.com/bageus/Dig/issues/433) |
...
| Заголовок | Aliases | Статус | Authoritative specification | Implementation / issue |
|---|---|---|---|---|
| Context input router | click priority, Alt, cursor, RMB cancel | `QUESTIONNAIRE` | [`../design/contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md) | [`../implementation/context-input-router.md`](../implementation/context-input-router.md), [#390](https://github.com/bageus/Dig/issues/390) |
...
| World/agent/building/item visuals | renderers, prefabs, projection | `IMPLEMENTED` | [`../design/presentation-input-ui-and-diagnostics.md`](../design/presentation-input-ui-and-diagnostics.md) | [`../implementation/unity-visual-asset-pipeline.md`](../implementation/unity-visual-asset-pipeline.md), [#14](https://github.com/bageus/Dig/issues/14) |
...
| Заголовок | Aliases | Статус | Authoritative specification | Implementation / issue |
|---|---|---|---|---|
| Save/load/migrations | snapshots, versions, restore | `IMPLEMENTED` | [`../design/save-load-and-migrations.md`](../design/save-load-and-migrations.md) | [`../implementation/save-load-migrations.md`](../implementation/save-load-migrations.md), [#13](https://github.com/bageus/Dig/issues/13) |
...
| Unity presentation host | bootstrap, modules, runtime scene | `IMPLEMENTED` | [`../design/presentation-input-ui-and-diagnostics.md`](../design/presentation-input-ui-and-diagnostics.md) | [`../implementation/unity-presentation-host.md`](../implementation/unity-presentation-host.md), [`../implementation/presentation-issue-14-closure-2026-07-29.md`](../implementation/presentation-issue-14-closure-2026-07-29.md), [#14](https://github.com/bageus/Dig/issues/14) |
