...
| Разрушаемые бочки с содержимым и падением | бочка, barrel, destructible, sword cursor, red highlight, loot, safe fall | `QUESTIONNAIRE` | [`destructible-barrels.md`](../design/destructible-barrels.md) | [#443](https://github.com/bageus/Dig/issues/443) |
...
| Destructible barrels, contents и safe falling | бочка, barrel, attack object, sword cursor, loot, support loss | `QUESTIONNAIRE` | [`../design/destructible-barrels.md`](../design/destructible-barrels.md) | [#443](https://github.com/bageus/Dig/issues/443) |
