...
| Excavation plans и cave templates | tunnel, room, depth designation | `APPROVED` | [`../design/excavation-room-templates-and-deposits.md`](../design/excavation-room-templates-and-deposits.md), [`../design/runtime-stacking-barrel-and-room-recovery-decisions.md`](../design/runtime-stacking-barrel-and-room-recovery-decisions.md) | [`../implementation/z0-excavation-planning.md`](../implementation/z0-excavation-planning.md), [#87](https://github.com/bageus/Dig/issues/87) |
