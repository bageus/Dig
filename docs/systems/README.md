...
| BuildingBox selection, unpacking, placement, assembly и packing | коробка здания, меню строения, кнопка распаковать, final-building ghost, pack | `QUESTIONNAIRE` | [`building-box-placement-and-packing.md`](../design/building-box-placement-and-packing.md), [`runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) + input/item contracts | [#118](https://github.com/bageus/Dig/issues/118), [#390](https://github.com/bageus/Dig/issues/390), [#398](https://github.com/bageus/Dig/issues/398) |
...
| Многоклеточная копка и прямые приказы | connected zone, tunnel chain, depth, room, manual excavation, quarter progress | `QUESTIONNAIRE` | [`excavation-command-execution.md`](../design/excavation-command-execution.md), [`runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [#388](https://github.com/bageus/Dig/issues/388) |
...
| Resident movement, directional lanes и vertical climbing | обход гномов, shared cell, right/left lane, карабканье | `QUESTIONNAIRE` | [`resident-movement-occupancy-and-vertical-traversal.md`](../design/resident-movement-occupancy-and-vertical-traversal.md) | [#386](https://github.com/bageus/Dig/issues/386) |
| Resident/building roster synchronization | открыть вкладку, подсветить строку, world/HUD selection | `QUESTIONNAIRE` | [`contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md), [`runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [#390](https://github.com/bageus/Dig/issues/390) |
...
| Excavation execution | direct dig, connected zone, automatic continuation, quarter progress | `QUESTIONNAIRE` | [`../design/excavation-command-execution.md`](../design/excavation-command-execution.md), [`../design/runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [`../implementation/unity-terrain-work-vertical-slice.md`](../implementation/unity-terrain-work-vertical-slice.md), [`../implementation/runtime-selection-excavation-item-placement.md`](../implementation/runtime-selection-excavation-item-placement.md), [#388](https://github.com/bageus/Dig/issues/388) |
...
| Resident movement occupancy | shared cell, directional lanes, passing, no swap | `QUESTIONNAIRE` | [`../design/resident-movement-occupancy-and-vertical-traversal.md`](../design/resident-movement-occupancy-and-vertical-traversal.md) | [`../implementation/layered-tunnel-movement.md`](../implementation/layered-tunnel-movement.md), [#386](https://github.com/bageus/Dig/issues/386) |
...
| BuildingBox lifecycle | select box, unpack button, final-building 3D ghost, assembly, packing | `QUESTIONNAIRE` | [`../design/building-box-placement-and-packing.md`](../design/building-box-placement-and-packing.md), [`../design/contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md), [`../design/runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [`../implementation/packable-building-lifecycle.md`](../implementation/packable-building-lifecycle.md), [`../implementation/runtime-selection-excavation-item-placement.md`](../implementation/runtime-selection-excavation-item-placement.md), [#398](https://github.com/bageus/Dig/issues/398) |
...
| Building functions и roster | production panel, pack/unpack button, building list, world selection sync | `QUESTIONNAIRE` | [`../design/resident-hud-selection-and-notifications.md`](../design/resident-hud-selection-and-notifications.md), [`../design/contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md), [`../design/runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [`../implementation/building-functions-panel.md`](../implementation/building-functions-panel.md), [`../implementation/runtime-selection-excavation-item-placement.md`](../implementation/runtime-selection-excavation-item-placement.md), [#390](https://github.com/bageus/Dig/issues/390) |
...
| Заголовок | Aliases | Статус | Authoritative specification | Implementation / issue |
|---|---|---|---|---|
| Context input router | click priority, Alt, cursor, RMB cancel | `QUESTIONNAIRE` | [`../design/contextual-input-cursors-and-selection.md`](../design/contextual-input-cursors-and-selection.md), [`../design/runtime-selection-excavation-item-placement-decisions.md`](../design/runtime-selection-excavation-item-placement-decisions.md) | [`../implementation/context-input-router.md`](../implementation/context-input-router.md), [`../implementation/runtime-selection-excavation-item-placement.md`](../implementation/runtime-selection-excavation-item-placement.md), [#390](https://github.com/bageus/Dig/issues/390) |
